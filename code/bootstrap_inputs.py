#!/usr/bin/env python3
"""Reconstruct the two redistributable analytical input files from compact text parts.

This repository stores gzip-compressed inputs as Base64 text fragments to keep the
Git history compact and transport-safe. This script joins, decodes, decompresses,
and verifies them before analysis.
"""
